<div style="display:flex; flex-direction:column; align-items:center;">
    ...
    <div style="display:flex;">
        <img style="width:460px; height:460px" src="front/public/images/readme/signup.png"/>
        <img style="width:460px; height:460px" src="front/public/images/readme/login.png"/>
    </div>
    <br/>
    ...
    <h3>상세페이지</h3>
    <div style="display:flex;">
        <img style="width:460px; height:460px" src="front/public/images/readme/detail.png"/>
        <img style="width:460px; height:460px" src="front/public/images/readme/detail2.png"/>
    </div>
    <br/>
    ...
    <h3>마이페이지</h3>
    <div style="display:flex;">
        <img style="width:460px; height:460px" src="front/public/images/readme/profile.png"/>
        <img style="width:460px; height:460px" src="front/public/images/readme/profile2.png"/>
    </div>
    <br/>
    ...
    <h3>상품 추천</h3>
    <div style="display:flex;">
        <img style="width:460px; height:460px" src="front/public/images/readme/recom.png"/>
        <img style="width:460px; height:460px" src="front/public/images/readme/recom2.png"/>
    </div>
    <br/>
    ...
    <div style="display:flex; justify-content:center;">
        <img style="width:300px; height:400px" src="front/public/images/readme/board2.png"/>
        <img style="width:300px; height:400px" src="front/public/images/readme/comments.png"/>
    </div>
    <br/>
    <p>✔️ 간단한 금융상품 후기를 남기는 느낌으로 포스트잇 컨셉으로 구현하여 게시판 생성, 수정, 삭제와 댓글 생성, 수정, 삭제 기능과 더불어 새고침시 랜덤으로 색깔 변경되어 재미요소 추가</p>
    <br/>
    <h3>AI 챗봇</h3>
