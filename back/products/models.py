...
class Deposit(models.Model):
    ...
    deposit_like_users = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="deposit_like_products"
    )  # 장바구니 한 유저
...
class Saving(models.Model):
    ...
    saving_like_users = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="saving_like_products"
    )  # 장바구니 한 유저
...
class Annuity(models.Model):
    ...
    annuity_like_users = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="annuity_like_products"
    )  # 장바구니 한 유저
