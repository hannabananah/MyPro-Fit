...
class DepositListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Deposit
        fields = ['dcls_month', 'fin_prdt_cd', 'kor_co_nm', 'fin_prdt_nm', 'month_6', 'month_12', 'month_24', 'month_36']
...
class AnnuityListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Annuity
        fields = ['dcls_month', 'fin_prdt_cd', 'kor_co_nm', 'fin_prdt_nm', 'prdt_type_nm', 'avg_prft_rate', 'btrm_prft_rate_1', 'btrm_prft_rate_2', 'btrm_prft_rate_3']
